...
export class ExpensesController {
  ...
  @Get()
  @ApiOperation({ summary: 'Daftar expense — OWNER/ADMIN' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Detail expense — OWNER/ADMIN' })
  @Roles(UserRole.OWNER, UserRole.ADMIN)
  ...
  @Post()
  @ApiOperation({ summary: 'Catat expense — OWNER/ADMIN' })
  @Roles(UserRole.OWNER, UserRole.ADMIN)
  ...
  @Patch(':id')
  @ApiOperation({ summary: 'Perbarui expense — OWNER/ADMIN' })
  @Roles(UserRole.OWNER, UserRole.ADMIN)
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Hapus expense — OWNER/ADMIN' })
  @Roles(UserRole.OWNER, UserRole.ADMIN)
