...
export class MeterReadingsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Daftar meter reading — semua role' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Detail meter reading — OWNER/ADMIN/STAFF' })
  ...
  @Post()
  @ApiOperation({ summary: 'Buat meter reading — OWNER/ADMIN/STAFF' })
  @Roles(UserRole.OWNER, UserRole.ADMIN, UserRole.STAFF)
  ...
  @Post('cycle')
  @ApiOperation({ summary: 'Catat siklus meter + generate invoice — OWNER/ADMIN/TENANT' })
  ...
  @Patch(':id')
  @ApiOperation({ summary: 'Perbarui meter reading — OWNER/ADMIN' })
