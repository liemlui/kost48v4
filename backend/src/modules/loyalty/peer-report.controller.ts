...
export class PeerReportController {
  ...
  @ApiOperation({ summary: 'Buat laporan perilaku sesama — TENANT' })
  ...
  @ApiOperation({ summary: 'Laporan yang saya buat — TENANT' })
  @Roles(UserRole.TENANT)
  ...
  @ApiOperation({ summary: 'Penghuni lain untuk dilaporkan — TENANT' })
  @Roles(UserRole.TENANT)
  ...
  @ApiOperation({ summary: 'Masukan tentang saya — TENANT' })
  @Roles(UserRole.TENANT)
  ...
  @ApiOperation({ summary: 'Tandai sudah diperbaiki — TENANT' })
  @Roles(UserRole.TENANT)
  ...
  @ApiOperation({ summary: 'Konfirmasi perbaikan — TENANT/ADMIN/OWNER' })
  ...
  @Get('peer-reports')
  @ApiOperation({ summary: 'Daftar laporan perilaku — OWNER/ADMIN' })
  ...
  @ApiOperation({ summary: 'Moderasi laporan perilaku — OWNER/ADMIN' })
  @Roles(UserRole.OWNER, UserRole.ADMIN)
