// FILE: MyTicketsPage.tsx — portal penghuni: daftar tiket laporan saya
...
const ticketCategoryOptions = [
  ...
  { value: 'FURNITURE', label: 'Perabot kamar' },
  { value: 'CLEANING', label: 'Kebersihan' },
  { value: 'PEST', label: 'Hama' },
  { value: 'SECURITY', label: 'Keamanan' },
  { value: 'NOISE', label: 'Keributan' },
  { value: 'CHECKIN_CHECKOUT', label: 'Masuk / keluar kamar' },
  { value: 'PAYMENT_ADMIN', label: 'Tagihan / Pembayaran' },
