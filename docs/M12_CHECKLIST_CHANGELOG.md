...
| **Fase AO — Audit & Hardening UI/UX Lintas Portal** | 🔴 audit selesai, eksekusi terbuka | 66 kombinasi browser + 74 route statis; 1 P0 environment, 6 P1, 7 P2, 1 P3 benchmark. Sumber kerja: `docs/M14_AUDIT_UI_UX.md`. |
...
> 25. **AO-00..AO-16** — 🔴 **ANTRIAN AKTIF** — audit UI/UX lintas portal 30 Jul 2026. Mulai dari sinkronisasi migration UAT, lalu perbaikan P1, crawl role, benchmark publik, dan audit ulang. Detail otoritatif: [M14 Audit UI/UX](M14_AUDIT_UI_UX.md).
>
