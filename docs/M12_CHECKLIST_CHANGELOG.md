...
- **Sumbu A — pelaksanaan (bukti commit + mapping + M13):** Tahap 1 DONE; Tahap 2 (antrean + riwayat, S0–S6) DONE; Tahap 3 — S1 `f8f9a589`/`de2d0459`, S2.a `3cca562f` (+ S2.a-fix `c3556bf3`, S2.a-fix-2 `c38fa833`), S2.b1 `f965a6dd`, S2.b2.a `cb1616d7`, S2.b2.b `1d66fd34`, **S2.b3 + S2.b4 (23 Sep 2026)**; sisa batch S2.c, S2.d, S3–S7; Tahap 4 (review akhir) belum dijalankan. Rincian per sub-langkah: [mapping Tahap 3](history/DOC-GOV-20260922-mapping.md) dan [M13](M13_CHANGELOG.md). Audit 360° M04 kini di `audit/audit-360-uang-2026-07.md`; status temuan: P1-01..P1-03 indikasi diperbaiki (statis), P1-04..P1-09 UNKNOWN.
- **Sumbu B — izin/approval (otoritas owner; tidak disimpulkan eksekutor):** Tahap 1 disetujui owner 22 Sep; Tahap 2 (S0–S6) + S1 + S2.a (+fix) + S2.b1 + S2.b2.a + S2.b2.b retro-approve kondisional owner 23 Sep ([M02](M02_KEPUTUSAN_OWNER.md)); **S2.b3/S2.b4 dijalankan atas instruksi percepatan owner 23 Sep (DOC-CEPAT)**; persetujuan penuh rancangan XL dan batch S2.c, S2.d, S3–S7, Tahap 4 belum tercatat — wajib approval per batch sebelum eksekusi. Prioritas owner 23 Sep: selesaikan tumpang tindih dokumentasi, lalu **fokus ke implementasi aplikasi** (FOKUS-IMPLEMENTASI).
...
| 8 | Penataan struktur dokumentasi (termasuk empat file non-M) | AI / **pelaksanaan:** Tahap 1 DONE, Tahap 2 (S0–S6) DONE, Tahap 3 berjalan (S1, S2.a, S2.b1, S2.b2.a, S2.b2.b, S2.b3, S2.b4 DONE; sisa S2.c, S2.d, S3–S7), Tahap 4 belum dijalankan; **izin:** Tahap 1 disetujui 22 Sep; Tahap 2 (S0–S6) + S1 + S2.a (+fix) + S2.b1 + S2.b2.a + S2.b2.b retro-approve kondisional 23 Sep; S2.b3/S2.b4 dijalankan atas instruksi percepatan owner 23 Sep; batch S2.c, S2.d, S3–S7, Tahap 4 wajib approval per batch; prioritas owner 23 Sep = selesaikan tumpang tindih docs lalu fokus implementasi aplikasi | Cakupan diperluas oleh prompt 22 Sep; mapping, kompatibilitas tautan, pelestarian isi, dan acceptance ada di rancangan DOC-GOV-20260922; [indeks dokumentasi](README.md) sudah dibuat pada Tahap 1; bukti Tahap 3 di [mapping](history/DOC-GOV-20260922-mapping.md) |
