...
**Bukan urutan eksekusi.** Urutan kerja hanya [Antrean Prioritas Aktif](../M12_CHECKLIST_CHANGELOG.md#antrean-prioritas-aktif) (anchor `#antrian-eksekusi-aktif` menunjuk ke tabel itu). Prioritas produk mengikuti keputusan owner 22 Sep di M02; gate EF tetap berlaku dan Fase MA tetap ditunda.
