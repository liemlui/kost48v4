...
> Stack: backend NestJS+Prisma+PostgreSQL (`backend/`), frontend React+Vite (`frontend/`). 39 modul · 54 model · 24 grup halaman.
...
- **Schema:** `backend/prisma/schema.prisma` (54 model). Generated client `backend/src/generated/prisma/` = **JANGAN baca** (32MB, regen `prisma generate`).
...
- **Growth:** LoyaltyPoint, LoyaltyReward, Redemption, PeerBehaviorReport, TenantReferral, Faq, AdditionalService, ServiceInterest, SatisfactionSurvey, TenantStaffReview, MarketAnalysis
