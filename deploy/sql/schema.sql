-- ⚠️ WARNING: ini akan menghapus semua tabel & data di schema public!
-- Hanya jalankan untuk FRESH INSTALL, bukan redeploy.
-- Untuk redeploy (DB sudah ada), cukup jalankan sql/seed.sql saja.
...
-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('GOOGLE_MAPS', 'WALK_IN', 'REFERRAL', 'INSTAGRAM', 'TIKTOK', 'WHATSAPP', 'FACEBOOK', 'WEBSITE', 'PORTAL', 'OTA', 'OTHER');
...
CREATE TABLE "Tenant" (
    ...
    "ktpVerificationMethod" VARCHAR(50),
    "ktpVerificationNotes" TEXT,
...
CREATE TABLE "OperationalSetting" (
    ...
    "ktpVerificationGateEnabled" BOOLEAN NOT NULL DEFAULT false,
    "adminWhatsappNumber" TEXT NOT NULL DEFAULT '6285648887628',
    "brevoApiKey" TEXT NOT NULL DEFAULT '',
    "mailFromEmail" TEXT NOT NULL DEFAULT 'no-reply@kost48surabaya.com',
    "mailFromName" TEXT NOT NULL DEFAULT 'Kost48 Surabaya',
    "autoOpsEnabled" BOOLEAN NOT NULL DEFAULT true,
    "recurringExpenseDraftsEnabled" BOOLEAN NOT NULL DEFAULT false,
    "assetDepreciationAutoEnabled" BOOLEAN NOT NULL DEFAULT false,
    "rentRecognitionEnabled" BOOLEAN NOT NULL DEFAULT false,
    "notificationPruningEnabled" BOOLEAN NOT NULL DEFAULT true,
    "notificationRetentionDays" INTEGER NOT NULL DEFAULT 90,
    "journalReconciliationEnabled" BOOLEAN NOT NULL DEFAULT false,
    "journalReconciliationLimit" INTEGER NOT NULL DEFAULT 100,
    "bookingReviewDeadlineHours" INTEGER NOT NULL DEFAULT 3,
    "approvedBookingPaymentDeadlineHours" INTEGER NOT NULL DEFAULT 3,
    "paymentReviewUrgentHours" INTEGER NOT NULL DEFAULT 1,
    "paymentReviewEscalateHours" INTEGER NOT NULL DEFAULT 3,
    "paymentReviewMaxHours" INTEGER NOT NULL DEFAULT 6,
    "invoiceUrgentAfterHours" INTEGER NOT NULL DEFAULT 6,
    "invoiceDueAfterHours" INTEGER NOT NULL DEFAULT 24,
    "renewReminderDays" INTEGER NOT NULL DEFAULT 3,
    "renewLastCallHours" INTEGER NOT NULL DEFAULT 24,
    "renewPaymentDeadlineHours" INTEGER NOT NULL DEFAULT 3,
    "renewReviewUrgentHours" INTEGER NOT NULL DEFAULT 3,
    "renewReviewEscalateHours" INTEGER NOT NULL DEFAULT 6,
    "checkoutReviewUrgentHours" INTEGER NOT NULL DEFAULT 3,
    "checkoutReviewEscalateHours" INTEGER NOT NULL DEFAULT 6,
    "checkoutFinalUrgentHours" INTEGER NOT NULL DEFAULT 6,
    "lateTenantVacateHours" INTEGER NOT NULL DEFAULT 3,
    "autoOpsIntervalMinutes" INTEGER NOT NULL DEFAULT 5,
    "acCleaningEnabled" BOOLEAN NOT NULL DEFAULT true,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "updatedById" INTEGER,
...
-- AddForeignKey
ALTER TABLE "IotIngestMessage" ADD CONSTRAINT "IotIngestMessage_deviceId_fkey" FOREIGN KEY ("deviceId") REFERENCES "IotDevice"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "IotTelemetry" ADD CONSTRAINT "IotTelemetry_ingestMessageId_fkey" FOREIGN KEY ("ingestMessageId") REFERENCES "IotIngestMessage"("id") ON DELETE CASCADE ON UPDATE CASCADE;
